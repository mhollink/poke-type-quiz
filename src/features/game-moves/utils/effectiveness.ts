...
export type TypeEffectivenessLookup = (
...
type DefensiveEffectiveness = Partial<Record<PokemonType, number>>;

const effectivenessByAttackType: Record<PokemonType, DefensiveEffectiveness> = {
	normal: {
		rock: 0.5,
		ghost: 0,
		steel: 0.5,
...
export function getTypeEffectiveness(
	...
	return effectivenessByAttackType[attackingType][defendingType] ?? 1;
}
