...
export function Game({ soundEnabled }: GameProps) {
					...
					<>
						...
						<Paper variant="outlined" sx={{ p: { xs: 3, md: 4 } }}>
							<Stack spacing={4}>
								...
								<PokemonAutocomplete
									key={`${game.state.currentChallenge.key}-${game.state.correctAnswers}`}
									pokemon={pokemonData}
									excludedPokemonIds={game.usedPokemonIdsForCurrentChallenge}
									minimumSearchLength={defaultGameConfig.minimumSearchLength}
									maximumSuggestions={defaultGameConfig.maximumSuggestions}
